...
public class VehicleDTO {
    ...
    public VehicleDTO(String id, String brand, String type, int passenger, String image, String transmission, String fuel, int milage, int priceperextrakm, int dailyrate, int freekmforday, int monthlyrate, int freekmformonth) {
        this.id = id;
        this.brand = brand;
        this.type = type;
